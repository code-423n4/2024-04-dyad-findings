...
| Id    | Issue                                                            | Instances |
| ----- | :--------------------------------------------------------------- | :-------: |
| [M-1] | The owner is a single point of failure and a centralization risk |     6     |
...
| [L-1] | Unused Constructor Declaration                                                               |     1     |

### Non-critical

| Id      | Issue                                                                                     | Instances |
| ------- | :---------------------------------------------------------------------------------------- | :-------: |
| [NC-1]  | NatSpec @param is missing                                                                 |    20     |
| [NC-2]  | Overridden function has no body                                                           |     8     |
| [NC-3]  | Mixed usage of int&#x2F;uint with int256&#x2F;uint256                                     |    11     |
| [NC-4]  | NatSpec @return argument is missing                                                       |     4     |
| [NC-5]  | Custom error has no error details                                                         |     3     |
| [NC-6]  | Non-external&#x2F;public variable and function names should begin with an underscore      |     1     |
| [NC-7]  | Lines are too long                                                                        |     1     |
| [NC-8]  | Typos in the code                                                                         |     9     |
| [NC-9]  | Function ordering does not follow the Solidity style guide                                |     3     |
| [NC-10] | Named mappings is recommended for understandability                                       |     1     |
| [NC-11] | Consider using named mappings                                                             |     1     |
| [NC-12] | Public functions not called by the contract should be declared external instead           |     2     |
| [NC-13] | File is missing NatSpec                                                                   |     2     |
| [NC-14] | Imports could be organized more systematically                                            |     2     |
| [NC-15] | constants should be defined rather than using magic numbers                               |     2     |
| [NC-16] | Events may be emitted out of order due to reentrancy                                      |     1     |
| [NC-17] | Events are missing sender information                                                     |     1     |
| [NC-18] | Events that mark critical parameter changes should contain both the old and the new value |     1     |
| [NC-19] | Variables need not be initialized to zero                                                 |     1     |

### Gas Optimizations

| Id    | Issue                                                                            | Instances | Total Gas Saved |
| ----- | :------------------------------------------------------------------------------- | :-------: | :-------------: |
| [G-1] | Functions guaranteed to revert when called by normal users can be marked payable |     6     |        -        |
| [G-2] | Optimize method and variable names to save gas                                   |     4     |        -        |
| [G-3] | Save gas by using private instead of public for constants                        |     1     |        -        |
| [G-4] | Constructors can be marked payable                                               |     3     |        -        |
| [G-5] | Zero initialization is redundant                                                 |     1     |        -        |
...
[Line 11](https://github.com/code-423n4/2024-04-dyad/src/core/Licenser.sol#L11)
...
[Line 14](https://github.com/code-423n4/2024-04-dyad/src/core/Licenser.sol#L14)
...
## [L-5]: Unused Constructor Declaration

There is a constructor declaration that is unused and should either be removed or implemented.
...
[Line 10](https://github.com/code-423n4/2024-04-dyad/src/core/Licenser.sol#L10)

---

### Non-critical

### [NC-1]: NatSpec @param is missing
...
### [NC-2]: Overridden function has no body
...
### [NC-3]: Mixed usage of int&#x2F;uint with int256&#x2F;uint256
...
### [NC-4]: NatSpec @return argument is missing
...
### [NC-6]: Non-external&#x2F;public variable and function names should begin with an underscore
...
/* File: Licenser.sol
	   Line: 9 */
constructor() {} // @audit unused contructor for inheritance, use the owned constructor implementation in the contructor or remove the constructor.
```

[Line 9](https://github.com/code-423n4/2024-04-dyad/src/core/Licenser.sol#L9)
...
### [NC-9]: Function ordering does not follow the Solidity style guide
...
[Line 6](https://github.com/code-423n4/2024-04-dyad/src/core/Licenser.sol#L6)
...
### [NC-10]: Named mappings is recommended for understandability
...
[Line 7](https://github.com/code-423n4/2024-04-dyad/src/core/Licenser.sol#L7)

### [NC-11]: Consider using named mappings
...
### [NC-14]: Imports could be organized more systematically
...
### [NC-15]: constants should be defined rather than using magic numbers
...
### [NC-17]: Events are missing sender information
...
### [NC-19]: Variables need not be initialized to zero
...
### [G-2]: Optimize method and variable names to save gas
...
### [G-3]: Save gas by using private instead of public for constants
...
### [G-5]: Zero initialization is redundant
